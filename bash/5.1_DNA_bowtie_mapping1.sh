...
#SBATCH --output=outlog_bowtie1.txt
#SBATCH --error=errorlog_bowtie1.txt

BASENAME="SG_05_27_2016"
...
#building mapping files from your contigs assembled, does not use scaffold file once this has completed
bowtie2-build ./IDBA/assembly_SG_05_27_2016/scaffold_05_27_2016.fa ./mapped_reads/$BASENAME
